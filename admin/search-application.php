...
<form name="search" method="post" >        
  ...
  <div class="row">
                      <div class="col-xl-6 col-lg-12">
                        <fieldset>
                          <h5>Search by Student Name / Email id / Contact number / Course Applied
...
$sdata=$_POST['searchdata'];
  ?>
<h4 text-align="center">Result againt "<?php echo $sdata;?>" keyword </h4>
<div class="row">
